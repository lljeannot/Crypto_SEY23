...
d15Nmod_source <- brm(d15N ~ taxloc + (1|Site), iter = 8000, warmup = 4000, cores = 4, data = source_SIA_mod)
...
d15Nmod_Sponge <- brm(d15N ~ Location + Location:Depth + (1|Site), iter = 8000, warmup = 4000, cores = 4, data = source_SIA %>% filter(Source == "Sponge"))
...
d15Nmod_crypto <- brm(d15N ~ 0 + taxloc + (1|Site), data = crypto_SIA_mod)
...
d15Nmod_Enneabel <- brm(d15N ~ Location + Location:Depth + (1|Site), iter = 8000, warmup = 4000, cores = 4, 
...
d13Cmod_source <- brm(d13C ~ taxloc + (1|Site), data = source_SIA_mod, iter = 8000, warmup = 4000, cores = 4, 
                      control = list(adapt_delta = 0.9))
...
d13Cmod_Sponge <- brm(d13C ~ Location + Location:Depth + (1|Site), data = source_SIA %>% filter(Source == "Sponge"),
                      iter = 8000, warmup = 4000, cores = 4, control = list(adapt_delta = 0.99))
...
d13Cmod_crypto <- brm(d13C ~ 0 + taxloc + (1|Site), iter = 8000, warmup = 4000, cores = 4, data = crypto_SIA_mod)
...
# model for Enneapterygius abeli
d13Cmod_Enneabel <- brm(d13C ~ Location + Location:Depth + (1|Site), iter = 8000, warmup = 4000, cores = 4, 
                        data = crypto_SIA_mod %>% filter(GENSPE == "Enneabel"))
...
Spr.mod <- brm(Spr_m ~ Location + Complexity + Location:Depth, family = lognormal, data = data_site)
Dens.mod <- brm(Ab_m ~ Location + Complexity + Location:Depth, family = lognormal, iter = 8000, warmup = 4000, cores = 4, data = data_site)
Biomass_m.mod <- brm(Biomass_m ~ Location + Complexity + Location:Depth, family = lognormal, data = data_site)
...
TL_mod_com <- brm(TL ~ Location + (1|GENSPE) + (1|Site), family = lognormal, iter = 8000, warmup = 4000, cores = 4, data = TL_mod_com.data)
...
TL_mod <- brm(TL ~ 0 + taxloc + (1|Site), family = lognormal, data = TL_mod.data)
...
W_mod <- brm(W ~ 0 + taxloc + (1|Site), iter = 8000, warmup = 4000, family = lognormal, data = W_mod.data)
...
uvc_biomass_all.prior <- brm(Biomass_m ~ Location, family = lognormal, prior = priors, data = uvc_data_biomass, sample_prior = "only")
# 
...
# model
uvc_biomass_all.mod <- brm(Biomass_m ~ Location, family = lognormal, prior = priors, data = uvc_data_biomass)
...
uvc_biomass.mod <- brm(Biomass_m ~ taxloc, family = lognormal, prior = priors, data = uvc_biomass.mod_data)
...
uvc_biomass.mod_depth <- brm(Biomass_m ~ Location + Location:Depth, family = lognormal, prior = priors, iter = 8000, warmup = 4000, cores = 4, 
...
uvc_biomass.mod_Herb <- brm(Biomass_m ~ Location + Location:Depth, family = lognormal, prior = priors, data = uvc_data_biomass_FG %>% 
                              filter(FG == "Herbivore"))
...
uvc_biomass.mod_other <- brm(Biomass_m ~ Location + Location:Depth, family = lognormal, prior = priors, data = uvc_data_biomass_FG %>% 
