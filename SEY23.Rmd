...
ggsave("figures/Fig5.png", uvc_biomass_depth.plot, width = 6, height = 8, units = "in", dpi = 600)
ggsave("figures/Fig5.pdf", uvc_biomass_depth.plot, width = 6, height = 8, units = "in", dpi = 600)
```
